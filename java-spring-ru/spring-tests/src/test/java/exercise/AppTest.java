...
public class AppTest {
    ...
    // BEGIN
    @Test
    void testGetPersonById_positive() throws Exception {
        MockHttpServletResponse response = mockMvc
    ...
    @Test
    void testUpdatePerson_positive() throws Exception {
        MockHttpServletResponse response = mockMvc
         .perform(
             ...
             patch("/people/2")
                 ...
                 .contentType(MediaType.APPLICATION_JSON)
                 .content("{\"firstName\": \"Alex\", \"lastName\": \"Perry\"}"))
         // Выполняем запрос и получаем ответ
         .andReturn()
         .getResponse();
        ...
        assertThat(response.getContentAsString()).contains("Alex", "Perry");
    }

    @Test
    void testDeletePerson_positive() throws Exception {
        MockHttpServletResponse response = mockMvc
